...
namespace MirrorMatchMaking
{
    ...
    public class Match
    {
        ...
        public Match(string matchID, PlayerCard player, bool publicMatch)
        {
            matchFull = false;
            inMatch = false;
    ...
    public class MatchMaker : NetworkBehaviour
    {
        ...
        public bool HostGame(string _matchID, PlayerCard _player, bool publicMatch, out int playerIndex)
        {
            playerIndex = -1;
        ...
        public bool JoinGame(string _matchID, PlayerCard _player, out int playerIndex)
        {
            playerIndex = -1;
        ...
        public bool SearchGame(PlayerCard _player, out int playerIndex, out string matchID)
        {
            playerIndex = -1;
            matchID = "";
        ...
        public void PlayerDisconnected(PlayerCard player, string _matchID)
        {
            for (int i = 0; i < matches.Count; i++)
            {
                if (matches[i].matchID == _matchID)
